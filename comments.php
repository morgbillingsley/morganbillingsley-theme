    ...
    <?php
        ...
        $comments_args = array(
                ...
                'fields'                => array(
                    ...
                    'cookies'   => '<div class="row"><div class="col-md-12"><p class="form-group"><input id="wp-comment-cookies-consent form-check-input" name="wp-comment-cookies-consent" type="checkbox" value="yes"><label for="wp-comment-cookies-consent" class="form-check-label pl-1">Remember me</label></p></div></div>'
                )
        );
